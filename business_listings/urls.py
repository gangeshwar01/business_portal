...
urlpatterns += [
    ...
    path('admin-dashboard/delete-contact/<int:contact_id>/', views.admin_delete_contact, name='admin_delete_contact'),
    path('my-contact-messages/', views.my_contact_messages, name='my_contact_messages'),
    path('admin-dashboard/reply-contact/<int:contact_id>/', views.admin_reply_contact, name='admin_reply_contact'),
] 